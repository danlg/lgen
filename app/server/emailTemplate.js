  ...
  return {
    "message": {
      ...
      "html":
        ...
        "<p class=\"p2\" style=\"margin: 0.0px 0.0px 0.0px 0.0px;font: 30.0px \'Helvetica Neue Light\';color: #343b42;\">" +
        "{{classname}} is ready for you to use<\/p> <p class=\"p3\" style=\"margin: 0.0px 0.0px 0.0px 0.0px;font: 16.0px " +
        "\'Helvetica Neue\';color: #a3a3a3;\">" +
        "Here are instructions\u00A0you can forward to or print for your class to start receiving your messages.<\/p>" +
        "<p class=\"p4\" style=\"margin: 0.0px 0.0px 0.0px 0.0px;font: 16.0px \'Helvetica Neue\';color: #a3a3a3;min-height: 18.0px;\">" +
        "<br><\/p> " +
        ...
        "<p class=\"p3\" style=\"margin: 0.0px 0.0px 0.0px 0.0px;font: 16.0px \'Helvetica Neue\';color: #a3a3a3;\">" +
        "Or share this link with your students and parents: " +
        "<a href=\"{{SHARE_URL}}\/{{classCode}}\"><span class=\"s1\" style=\"color: #2ba6cb;\">{{SHARE_URL}}\/{{classCode}}" +
        "<\/span><\/a><\/p>\r\n\r\n<p>\r\n  " +
...
inviteClassMailTemplateTest = function (to, classObj) {
  ...
  message.global_merge_vars.push({"name": "SHARE_URL", "content": Meteor.settings.public.SHARE_URL});
  message.global_merge_vars.push({"name": "ROOT_URL", "content": Meteor.settings.public.ROOT_URL});
